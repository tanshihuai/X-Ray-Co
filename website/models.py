...
class Diagnosis(models.Model):
    ...
    D_SymptomRisk = models.CharField(max_length=101)
    D_XRayRisk = models.CharField(max_length=101)
    D_AtRiskOf = models.CharField(max_length=100)
    D_XRayPicture = models.ImageField(max_length=110, upload_to='images')
    D_CovidDiagnosis = models.CharField(max_length=101, choices=COVID_CHOICES, default='positive')
